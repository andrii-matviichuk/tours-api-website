  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, host) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51I6HQ9EcpnjS8OMUSluPM6cEMEsH7H6FC9pGRvWRvQEETQQmr9TewxuqX2vPglHAxacxrdmFgTSb3f95AqPEgbA700qBPZoVZP');
            _context.prev = 1;
            _context.next = 4;
...
if (bookTourBtn) {
  bookTourBtn.addEventListener('click', function (e) {
    ...
    var host = window.location.protocol + '//' + window.location.host;
    (0, _stripe.bookTour)(tourId, host);
  });
}
