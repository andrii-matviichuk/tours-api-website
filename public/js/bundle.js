...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, host) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(host, "/api/v1/users/login"),
              data: {
                email: email,
                password: password
              }
          ...
          case 3:
            ...
            if (res.data.message === 'success') {
              (0, _alert.showAlert)('success', 'Succefully logged in!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            updateType = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(updateType),
              data: data
            });
...
/* eslint-disable */
var displayMap = function displayMap(dataset) {
  ...
  dataset.locations.forEach(function (loc) {
...
var stripe = Stripe('pk_test_51I6HQ9EcpnjS8OMUSluPM6cEMEsH7H6FC9pGRvWRvQEETQQmr9TewxuqX2vPglHAxacxrdmFgTSb3f95AqPEgbA700qBPZoVZP');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, host) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("".concat(host, "/api/v1/bookings/checkout-session/").concat(tourId));
...
if (mapBox) {
  var dataset = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(dataset);
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(email, password, host);
  });
}
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return (0, _stripe.bookTour)(tourId, host);
